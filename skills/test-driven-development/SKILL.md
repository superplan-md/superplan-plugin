...
- keep the verification path aligned with what `review-task-against-ac` will later judge
...
After green, execution continues through the normal shaped path and later review still flows through `review-task-against-ac`.
