---
name: superplan-regression-guarding
...
- `superplan-test-driven-development` when the guard should be written before the full fix
- `superplan-verification-before-completion` when the new guard becomes part of the proof path
- `superplan-retrospective-postmortem` when the missing guard revealed a broader process gap
