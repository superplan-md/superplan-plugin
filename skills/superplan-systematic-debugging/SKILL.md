---
name: superplan-systematic-debugging
...
Once root cause is clear, execution may continue through `superplan-execute-task-graph`.
If the investigation reveals structural drift, hand back to `superplan-shape-work`.
