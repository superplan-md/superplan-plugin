...
- confirm it does not silently replan work that belongs back in `superplan-shape-work`
- confirm strategic goal change routes up to `superplan-route-work`
...
- review-ready work hands off to `superplan-review-task-against-ac`
- structural drift hands off to `superplan-shape-work`
- strategic drift hands off to `superplan-route-work`
