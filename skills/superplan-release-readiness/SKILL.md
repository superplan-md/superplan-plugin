---
name: superplan-release-readiness
...
- `superplan-verification-before-completion` for missing proof
- `superplan-docs-sync` for stale release docs
- `superplan-execute-task-graph` for the concrete blocker fixes
