...
- `superplan-route-work` has decided Superplan should engage
...
- `superplan-route-work` decided to stay out
...
- back to `superplan-route-work` only if shaping discovers the engagement or depth decision was materially wrong
