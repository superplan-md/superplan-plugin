...
Use these scenarios to test whether `superplan-route-work` chooses the smallest useful depth without silently shaping or executing.
...
- hands off to `superplan-shape-work` or `superplan-context-bootstrap-sync` instead of absorbing adjacent responsibilities
