...
- confirm unmet AC hands back to `superplan-execute-task-graph` rather than becoming quiet replanning
- confirm contract mismatch hands back to `superplan-shape-work`
- confirm missing or weak proof routes to `superplan-verification-before-completion` rather than pretending review can finish
