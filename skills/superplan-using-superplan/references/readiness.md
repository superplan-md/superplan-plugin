...
Use this reference when `superplan-using-superplan` needs to decide whether the repo or host is ready for structured Superplan workflow.
...
- resume the owning workflow phase or route to `superplan-route-work`
...
- ready: route to the owning workflow phase or `superplan-route-work`
- context-missing: route to `superplan-context-bootstrap-sync`
