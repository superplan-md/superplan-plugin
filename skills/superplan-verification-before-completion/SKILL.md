---
name: superplan-verification-before-completion
...
- hand results cleanly to `superplan-review-task-against-ac` when tracked task completion is at stake
...
For tracked tasks, verification hands into `superplan-review-task-against-ac`.
