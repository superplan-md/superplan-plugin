...
- `superplan-release-readiness` when docs were part of a ship gate
- `superplan-verification-before-completion` for targeted proof like `rg`, `--help`, or install-flow checks
