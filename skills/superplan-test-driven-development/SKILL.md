---
name: superplan-test-driven-development
...
- keep the verification path aligned with what `superplan-review-task-against-ac` will later judge
...
After green, execution continues through the normal shaped path and later review still flows through `superplan-review-task-against-ac`.
