...
- confirm unmet AC hands back to `superplan-execute` rather than becoming quiet replanning
- confirm contract mismatch hands back to `superplan-shape`
- confirm missing or weak proof routes to `superplan-verify` rather than pretending review can finish
